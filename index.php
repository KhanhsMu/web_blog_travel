...
<div id="mobile_menu">
        <ul class="nav nav-pills nav-stacked">
            <li><a href="#banner_slide"><i class="glyphicon glyphicon-home"></i> &nbsp; Trang chủ</a></li>
            <li><a href="#about"><i class="glyphicon glyphicon-briefcase"></i> &nbsp; Giới thiệu</a></li>
            <li><a href="#events"><i class="glyphicon glyphicon-bullhorn"></i> &nbsp; Diễn đàn</a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-6 hidden-xs">
                <ul class="nav nav-justified">
                    <li><a href="#banner_slide">Trang chủ</a></li>
                    <li><a href="#about">Giới thiệu</a></li>
                    <li><a href="#events">Diễn đàn</a></li>
